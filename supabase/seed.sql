...
-- 插入posts
INSERT INTO
  "public"."tags" ("name", "slug", "description")
VALUES
  ('test', 'test', 'default test tag') ON CONFLICT (slug) DO NOTHING;

INSERT INTO
  "public"."categories" ("name", "slug", "description")
VALUES
  ('default', 'default', 'default') ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO
  "public"."posts_tags" ("tag_id", "post_id")
SELECT
  (
    SELECT
      id
...
INSERT INTO
  "public"."posts_categories" ("category_id", "post_id")
SELECT
  (
    SELECT
      id
